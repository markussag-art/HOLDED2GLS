...
export function createShipment(data: Partial<Shipment> & Pick<Shipment, 'holdedDocumentId'>): Shipment {
  ...
  const shipment: Shipment = {
    ...
    glsRawResponse: data.glsRawResponse || null,
  ...
  db.prepare(`
    INSERT INTO shipments (
      id, holdedDocumentId, holdedDocType, waybillNumber,
      recipientName, recipientCommercialName, recipientAddress, recipientCity,
      recipientProvince, recipientPostcode, recipientCountry, recipientPhone, recipientEmail,
      weight, packages, shippingMethod, deliveryNotes,
      trackingNumber, expeditionId, labelPdfPath, glsRawResponse, trackingUrl,
